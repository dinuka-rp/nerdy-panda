...
\begin{figure}[h!]
\centering
\frame{\includegraphics[width=\textwidth]{images/SRS/context-diagram.png}}
...
\begin{figure}[h!]
\centering
\frame{\includegraphics[width=\textwidth]{images/SRS/use-case-diagram.png}}
...
% \begin{longtable}{|p{0.2\textwidth}|p{0.77\textwidth}|}
% \caption{test use case description}\\ 
% \hline
% Use Case & Change the State of a Ticket \endfirsthead 
% \hline
% Id & UC:04 \\ 
% \hline
% Description & Change the state of a Ticket that has been created  saved in the system. \\ 
% \hline
% Primary Actor & User \\ 
% \hline
% Supporting Actors (if any) & none \\ 
% \hline
% Stakeholders and Interests (if any)~ & Users that have been already assigned to the Ticket, All users of the System (other Developers  Admins). \\ 
% \hline
% Pre-‐Conditions & \begin{tabular}[c]{@{}l@{}}A user has to be logged into the system.\\The required Ticket to be updated has to have been created.\end{tabular} \\ 
% \hline
% Post Conditions & \begin{tabular}[c]{@{}l@{}}Success end condition\\The state of a Ticket gets updated in the system.\end{tabular} \\ 
% \hline
% Trigger & A user wishes to update the state of a Ticket in the system. \\ 
% \hline
% Main Success Scenario~ & \begin{tabular}{@{\labelitemi\hspace{\dimexpr\labelsep+0.5\tabcolsep}}l@{}}User selects the current state of a Ticket.\\User selects the new state of the Ticket.\\System authenticates the User.\\System updates the state of the Ticket.\\System displays the updated list of Tickets with the updated ticket status.\end{tabular} \\ 
% \hline
% Variations & A user can change the state of the Ticket when updating the Ticket. \\
% \hline
% \end{longtable}
