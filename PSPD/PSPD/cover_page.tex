...
\vfill
% Authors
\text{\large A Project Specification Design and Prototype Doc by}\\[0.1cm]
...
\vfill
\text{\large March 2022}\\[0.1cm]

\vfill
\large{Submitted in partial fulfilment of the requirements for \\the BSc (Hons) Computer Science degree at \\the University of Westminster.} \\[0.1cm]
